...
//==============================================================================
void LookAndFeelO::drawButtonBackground (Graphics& g,
                                                 Button& button,
...
void LookAndFeelO::drawTickBox (Graphics& g,
                                        Component& /*component*/,
...
void LookAndFeelO::drawToggleButton (Graphics& g,
                                             ToggleButton& button,
                                             bool isMouseOverButton,
                                             bool isButtonDown)
{
...
void LookAndFeelO::drawProgressBar (Graphics& g, ProgressBar& progressBar,
...
void LookAndFeelO::drawScrollbarButton (Graphics& g,
                                                ScrollBar& bar,
                                                int width, int height,
                                                int buttonDirection,
...
void LookAndFeelO::drawScrollbar (Graphics& g,
                                          ScrollBar& bar,
                                          int x, int y,
                                          int width, int height,
                                          bool isScrollbarVertical,
...
ImageEffectFilter* LookAndFeelO::getScrollbarEffect()
{
...
//==============================================================================
void LookAndFeelO::drawPopupMenuBackground (Graphics& g, int width, int height)
{
...
void LookAndFeelO::drawMenuBarBackground (Graphics& g, int /*width*/, int /*height*/,
...
//==============================================================================
void LookAndFeelO::drawTextEditorOutline (Graphics& g, int width, int height, TextEditor& textEditor)
{
...
//==============================================================================
void LookAndFeelO::drawComboBox (Graphics& g, int width, int height,
                                         const bool isButtonDown,
...
const Font LookAndFeelO::getComboBoxFont (ComboBox& box)
{
...
void LookAndFeelO::drawLinearSlider (Graphics& g,
                                             int x, int y,
                                             int w, int h,
                                             float sliderPos,
                                             float minSliderPos,
...
Button* LookAndFeelO::createSliderButton (const bool isIncrement)
{
    if (isIncrement)
...
ImageEffectFilter* LookAndFeelO::getSliderEffect()
{
    return &scrollbarShadow;
}

int LookAndFeelO::getSliderThumbRadius (Slider&)
{
    return 8;
}

//==============================================================================
void LookAndFeelO::drawCornerResizer (Graphics& g,
                                              int w, int h,
                                              bool isMouseOver,
...
//==============================================================================
Button* LookAndFeelO::createDocumentWindowButton (int buttonType)
{
    Path shape;
...
void LookAndFeelO::positionDocumentWindowButtons (DocumentWindow&,
                                                          int titleBarX,
                                                          int titleBarY,
                                                          int titleBarW,
                                                          int titleBarH,
